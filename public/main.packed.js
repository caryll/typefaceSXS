...
},{"./novel.vue":31,"./sync.vue":32,"./weights.vue":33,"axios":2,"vue":29}],31:[function(require,module,exports){
;(function(){
//
//
//
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"suite sync"},[_c('section',{staticClass:"main",style:({maxWidth: _vm.typography.width + 'rem'})},[_c('div',{staticClass:"toolbar"},[_vm._v("Current Style: "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.currentStyle),expression:"currentStyle"}],on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.currentStyle=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},_vm._l((_vm.styles),function(sty,sid){return _c('option',{domProps:{"value":sid}},[_vm._v(_vm._s(sid))])})),_vm._v(" | Text size synchronized with global config.")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.sample),expression:"sample"}],class:[_vm.typeface1],style:({
						  ...
						  }),domProps:{"value":(_vm.sample)},on:{"keypress":function($event){$event.stopPropagation();},"input":function($event){if($event.target.composing){ return; }_vm.sample=$event.target.value}}})]),_vm._v(" "),_c('section',{staticClass:"opposite",style:({maxWidth: _vm.typography.width + 'rem'})},[_c('div',{staticClass:"toolbar"},[_vm._v("Current Style: "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.currentStyle),expression:"currentStyle"}],on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.currentStyle=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},_vm._l((_vm.styles),function(sty,sid){return _c('option',{domProps:{"value":sid}},[_vm._v(_vm._s(sid))])})),_vm._v(" | Text size synchronized with global config.")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.sample),expression:"sample"}],class:[_vm.typeface2],style:({
						  fontSize: _vm.typography.size + 'px',
						  textAlign: _vm.typography.align,
						  fontWeight: (_vm.styles[_vm.currentStyle]||{}).weight||400,
						  fontStyle: (_vm.styles[_vm.currentStyle]||{}).style||'normal',
						  }),domProps:{"value":(_vm.sample)},on:{"keypress":function($event){$event.stopPropagation();},"input":function($event){if($event.target.composing){ return; }_vm.sample=$event.target.value}}})])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
